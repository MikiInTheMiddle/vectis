...
const values = [
  ...
  ["04","Valore, non volume","Il lavoro si organizza attorno alla qualità della decisione. L’efficienza resta una conseguenza del metodo."],
  ["05","Tempestività senza compromessi","La velocità non modifica gli standard di verifica, accuratezza e responsabilità professionale."],
];
...
const advantages = [
  ["01","Qualità della decisione","Il recupero strutturato della conoscenza amplia le informazioni disponibili e rende più solide le opzioni sottoposte al cliente."],
  ["02","Tempestività","Pipeline specializzate e conoscenza già organizzata riducono i tempi necessari per arrivare alla valutazione professionale."],
  ["03","Accuratezza e Risk Control","Segregazione dei dati, tracciabilità e quality review aumentano profondità e affidabilità del lavoro."],
  ["04","Costi chiari e preventivabili","Workflow definiti rendono l’impegno più misurabile e permettono di concordare costi allineati al valore."],
];

const expertise = [
  {n:"01",title:"Operazioni straordinarie",subtitle:"Decisioni complesse, informazioni leggibili.",doing:"Fusioni / Acquisizioni / Riorganizzazioni societarie / Due diligence",change:"Documenti, clausole, anomalie e aree di rischio vengono ricondotti alla struttura dell’operazione. Ogni rilievo resta collegato alle fonti e alle priorità della decisione.",caseTitle:"Case history da integrare"},
  {n:"02",title:"Diritto societario e compliance integrata",subtitle:"Governance e controllo in un unico quadro.",doing:"Corporate governance / Segreteria societaria / Sistemi di controllo interno / Programmi di compliance integrata",change:"Delibere, deleghe, obblighi, scadenze ed evidenze di controllo vengono organizzati in un presidio coerente. Responsabilità e adempimenti diventano tracciabili nel tempo.",caseTitle:"Case history da integrare"},
  {n:"03",title:"Contrattualistica commerciale",subtitle:"Negoziare con più conoscenza disponibile.",doing:"Drafting / Revisione contrattuale / Negoziazione",change:"Clausole, precedenti e scostamenti dagli standard diventano confrontabili. Rinnovi, obblighi e posizioni negoziali emergono con maggiore chiarezza nel patrimonio contrattuale.",caseTitle:"Case history da integrare"},
  {n:"04",title:"Normativa AI",subtitle:"Conformità alla regolazione dell’intelligenza artificiale.",doing:"Analisi del perimetro normativo / Governance AI / Valutazione dei rischi / Supporto alla conformità",change:"Casi d’uso, classificazioni di rischio, ruoli e obblighi documentali vengono mappati in un quadro operativo. La conformità accompagna l’adozione e i successivi aggiornamenti.",caseTitle:"Case history da integrare"},
  {n:"05",title:"Vectis inHouse / Managed Legal Services",subtitle:"Un presidio continuativo per decidere prima dell’urgenza.",doing:"Contrattualistica corrente / Governance / Compliance e privacy / Normativa AI / Monitoraggio regolatorio",change:"Questioni correnti, documenti e scadenze alimentano un centro di conoscenza dedicato all’impresa. Management e funzione legale dispongono di un unico presidio, anche per gli aggiornamenti regolatori.",caseTitle:"Case history da integrare",deepDive:true},
];
...
function AboutPage() { return <>
  ...
  <section className="principlesBlock internalSection"><div className="wrap internalSplit"><h2>AI First è una scelta<br /><em>fondativa.</em></h2><div><p className="bigCopy">Vectis non ha aggiunto la tecnologia a un modello preesistente.</p><p>Ha costruito fin dall’origine una struttura in cui esperienza legale, organizzazione e strumenti AI possono evolvere insieme. Il funzionamento operativo di questo modello è approfondito nella pagina Metodo.</p><a className="underLink" href="/metodo">Scopri il Metodo <b>→</b></a></div></div></section>
...
function TeamPage() { return <>
  <section className="internalEditorial internalSection wrap"><p className="consultingKicker">Organizzazione e responsabilità</p><div className="internalSplit"><h2>Una struttura,<br /><em>non una somma di nomi.</em></h2><div><p className="bigCopy">La Società Tra Avvocati definisce organizzazione, ruoli e regole di governo chiare.</p><p>I founder guidano la struttura e assumono la responsabilità professionale del lavoro svolto.</p></div></div></section>
  ...
  <section className="teamCulture internalSection"><div className="wrap internalSplit"><h2>Competenze diverse.<br /><em>Responsabilità definite.</em></h2><div><p className="bigCopy">Professionisti legali e specialisti AI lavorano nello stesso processo, con ruoli distinti.</p><p>Gli specialisti progettano e attivano i workflow. Strategia, esecuzione, supervisione e responsabilità professionale restano in capo agli avvocati. I profili completi saranno integrati quando disponibili.</p></div></div></section>
</>; }
